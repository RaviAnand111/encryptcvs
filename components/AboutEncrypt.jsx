...
function AboutEncrypt({aboutusRef, missionRef}){
 return (
   ...
   <p className={styles.content}>
       <p><span className={styles.e}>E</span>ncrypt-The tech society of CVS is no less than a convent for all the students who wish to excel in any field in this technology dominated world. It is a platform where all the students diligently work towards spreading technical education and awareness. Learning and subsequently polishing their own set of skills will help them take the world head on.</p>
       <p className={styles.content}>
       <br></br>
